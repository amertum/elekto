...
public class OperationLoader {
    ...
    /**
     * Return the {@link Operation} read from the provided excel file {@link InputStream}. The stream will be closed.
     * 
        ...
        throws IOException
    {
        ...
        final HSSFSheet etablissements = workbook.getSheetAt(0);
        final HSSFSheet candidats = workbook.getSheetAt(1);
