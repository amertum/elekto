...
public class ResultsControllerIT {
        ...
        throws Exception
    {
        ...
        final String filepath = new File(this.getClass().getResource(
                "/results-template-example.xls").toURI()).getAbsolutePath();
        fileInput.sendKeys(filepath);
        fileInput.submit();
        
        assertEquals(
                "currentTourIndex : 1",
                driver.findElement(By.id("currentTourIndex")).getText());
